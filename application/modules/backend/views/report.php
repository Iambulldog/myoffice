                        ...
                        <div class=row>
                            <div class="col-md-4 mb-4">
                                ...
                                <select class="mb-2 form-control selectpicker" name="type" id="type">
                                    <option value="0" <?php if ($type == 0) { echo "selected";  } ?>> ทั้งหมด </option>
                                    <option value="1" <?php if ($type == 1) { echo "selected";  } ?>>ฝาก</option>
                                    <option value="2" <?php if ($type == 2) { echo "selected";  } ?>>ถอน</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-4">
        ...
        <div class="card-header py-3">
            <h6 >
                ...
                <span class="m-0 font-weight-bold text-primary">
                 ...
                 if ($s_user != 0){
                    foreach ($user as $k => $val) { 
                            if ($s_user == $val->id) { echo $val->name;  }
                    } 
                }else{
                    echo "ทั้งหมด";
                }
...
<?php $title ="รายการ:";
                ...
                $title .= "ผู้ใช้:";
                 ...
                 if ($s_user != 0){
                    foreach ($user as $k => $val) { 
                            if ($s_user == $val->id) { $title .=  $val->name;  }
                    } 
                }else{
                    $title .= "ทั้งหมด ";
                }
